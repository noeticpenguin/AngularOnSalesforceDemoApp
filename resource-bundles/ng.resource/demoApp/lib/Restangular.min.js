...
(function() {
  ...
  module.provider('Restangular', function() {
    ...
    Configurer.init = function(object, config) {
      ...
      config.onBeforeElemRestangularized = config.onBeforeElemRestangularized ||
      function(elem) {
        return elem;
      };
       ...
       *
       */
      config.onElemRestangularized = config.onElemRestangularized ||
      function(elem) {
        return elem;
      };
      ...
      config.shouldSaveParent = config.shouldSaveParent ||
      function() {
        return true;
      };
      ...
      function createServiceForConfiguration(config) {
        ...
        function restangularizeBase(parent, elem, route, reqParams, fromServer) {
          ...
          if (parent && config.shouldSaveParent(route)) {
            ...
            _.values(_.pick(config.restangularFields, ['route', 'parentResource'])), config.extraFields);
